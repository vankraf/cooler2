...
const Floor3 = props => (
	<Panel id={props.id}>
		...
		<Div style={{display: 'flex'}}>
            <Button size="l" stretched  style={{ marginRight: 8 }} onClick={props.go} data-to="floor1">1</Button>
        ...
        <div style={{
          ...
          <Button size="xl" stretched level="overlay_secondary" before={<Icon20LikeOutline/>} style={{ marginRight: 8,marginLeft: 8 }} >5</Button>
          <Button size="xl" stretched level="overlay_secondary" before={<Icon20LikeOutline/>} style={{ marginRight: 8, marginLeft: 8}} >6</Button>
