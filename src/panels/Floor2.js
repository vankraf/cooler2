...
const Floor2 = props => (
	<Panel id={props.id}>
        ...
        <div style={{
          ...
          <Button size="xl" stretched level="overlay_secondary" before={<Icon20LikeOutline/>} style={{ marginRight: 8,marginLeft: 8 }} >3</Button>
          <Button size="xl" stretched level="overlay_secondary" before={<Icon20LikeOutline/>} style={{ marginRight: 8, marginLeft: 8}} >4</Button>
